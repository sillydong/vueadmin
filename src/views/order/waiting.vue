...
<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-select v-model="table.query.type" placeholder="配送类型" :clearable="true" class="filter-item" style="width: 100px;">
        <el-option v-for="(item,index) in types" :key="index" :label="item" :value="index"></el-option>
      </el-select>
      <el-select v-model="table.query.pick_shop_id" placeholder="提货门店" :clearable="true" class="filter-item">
        <el-option v-for="(item,index) in shops" :key="index" :label="item" :value="index"></el-option>
      </el-select>
